...
export const selectErrorLogin = createSelector([selectDomain], user => user.response.login.error);
export const selectErrorRegister = createSelector([selectDomain], user => user.response.register.error);
