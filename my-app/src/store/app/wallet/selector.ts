...
export const selectBalance = createSelector([selectDomain], wallet => wallet.balance);
export const selectESOP = createSelector([selectDomain], wallet => wallet.esop);
export const selectStock = createSelector([selectDomain], wallet => wallet.stock);

export const selectHistoryTransaction = createSelector([selectDomain], wallet => wallet.history_transaction);
export const selectHistoryTransactionESOP = createSelector([selectDomain], wallet => wallet.history_transaction_ESOP);
